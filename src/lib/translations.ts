...
export const translations = {
  sq: {
    ...
    orderSuccessTitle: "Faleminderit",
    orderSuccessBody: "Pagesa u pranua. Do të të kontaktojmë për dorëzim.",
  ...
  en: {
    ...
    orderSuccessBody: "Payment received. We’ll contact you about delivery.",
    mobileEnquireSticky: "WhatsApp",
