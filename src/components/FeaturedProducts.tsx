...
export default function FeaturedProducts({ products }: Props) {
  ...
  return (
    <section id="featured" className="relative py-16 md:py-20 bg-surface bg-surface-noise">
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-8 md:mb-10">
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl font-semibold uppercase tracking-tight text-ink">
              {t.catalogueFeatured}
            </h2>
          </div>
          <Link
