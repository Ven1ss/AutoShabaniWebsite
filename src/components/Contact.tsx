...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative py-16 md:py-20 bg-surface-alt">
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-4xl font-semibold uppercase tracking-tight text-ink mb-10">
              {t.contactTitle}
            </h2>
