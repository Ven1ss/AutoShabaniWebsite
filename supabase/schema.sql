...
-- After this schema, also run search_products.sql, migrations/001_improvements.sql
-- (auth/ratings/orders), and 003_online_ordering_foundation.sql if upgrading an older DB.
